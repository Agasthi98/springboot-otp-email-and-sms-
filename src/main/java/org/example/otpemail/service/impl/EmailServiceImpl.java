...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    public DefaultResponse sendSimpleMail(EmailDetails details) {
        ...
        try {
            ...
            return new DefaultResponse(200, "Success", "Mail Sent Successfully");
        }
        // Catch block to handle the exceptions
        catch (Exception e) {
            return new DefaultResponse(400,"Failed", "Send email failed");
        }
    }
